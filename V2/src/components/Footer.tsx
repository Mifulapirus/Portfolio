      ...
      <div className="px-4 md:px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400">Building innovative solutions across hardware and software</p>
          </div>
          <div className="flex gap-6">
            ...
            <a
              href="https://www.linkedin.com/in/angelhernandezmejias/"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="mt-8 pt-8 border-t border-primary/20 text-center text-gray-400">
            <p>&copy;All rights reserved... whatever, most of my stuff is public anyway :)</p>
          </div>
        </div>
      </div>
    </footer>
